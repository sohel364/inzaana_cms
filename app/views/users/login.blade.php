		...
		<div class="col-md-6 backgroundWhite animatedParent animateOnce">
			<div class="row">
				<div class="col-xs-12 col-md-8 col-md-offset-2 marTop100 text-center">
					<% HTML::image('public/images/signInResponsive.png','',array('alt'=>'','class'=>'img-responsive animated fadeInRightShort')) %>
				   ...
				   <label class="padDown animated growIn">Dont have any account yet?<a href="<% URL::to('/users/register'); %>" class="btn btn-link">Create your own store!</a></label>
				</div>
			</div>
		</div>
    </div>
