...
<head>
	...
	<!-- all angular resources will be loaded from the /public folder -->
		...
		<script src="public/js/services/commentService.js"></script> <!-- load our service -->
		<script src="public/js/controllers/autoCplCtrl.js"></script> <!-- load our controller -->
		<script src="public/js/services/cityService.js"></script> <!-- load our service -->
